...
public class Jfinal {
    public Object jfinalInitMysqlDB() {
        String url="jdbc:mysql://mysql.uat.kanghong.local:3306/ec_order_uat?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&failOverReadOnly=false&serverTimezone=Asia/Shanghai&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
    ...
    public Object jfinalInitMssqlDB() {
        String url="jdbc:sqlserver://mssql.uat.kanghong.local;DatabaseName=Inspharmacy";
